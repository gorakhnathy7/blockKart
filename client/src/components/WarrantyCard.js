...
function WarrantyCard() {
  ...
  useEffect(() => {
    if (nftData != null) {
      nftData.attributes.map((element) => {
        if (element.trait_type == "image") setImgLink(element.value);
      });
    }
  });
  useEffect(() => {
    if (nftData != null) {
      nftData.attributes.map((element) => {
        if (element.trait_type == "name") setName(element.value);
      });
    }
  });
  useEffect(() => {
    if (nftData != null) {
      nftData.attributes.map((element) => {
        if (element.trait_type == "tokenId") setTokenId(element.value);
      });
    }
  });
  useEffect(() => {
    if (nftData != null) {
      nftData.attributes.map((element) => {
        if (element.trait_type == "price") setPrice(element.value);
      });
    }
  });
  useEffect(() => {
    if (nftData != null) {
      nftData.attributes.map((element) => {
        if (element.trait_type == "description") setDescription(element.value);
      });
    }
  });
  useEffect(() => {
    if (nftData != null) {
      nftData.attributes.map((element) => {
        if (element.trait_type == "serial") setSerial(element.value);
      });
    }
  });
  useEffect(() => {
    ...
    if (nftData != null) {
      nftData.attributes.map((element) => {
        if (element.trait_type == "createdTime") x = element.value;
        if (element.trait_type == "warranty") y = element.value;
      });
    }
  ...
  useEffect(() => {
    if (nftData != null) {
      nftData.attributes.map((element) => {
        if (element.trait_type == "warranty") setWarranty(element.value);
      });
    }
  });
      ...
      <>
        <div className="war-card">
          <div className="war-thumbnail">
            <img className="left" src={imgLink} />
          </div>
          <div className="right">
            ...
            return (
              <tr>
                ...
                <tr>
                  <th>Warranty Left</th>
                  <td>
                    {warrLeft.years} years {warrLeft.months} months
                  </td>
                </tr>
              </table>
            ) : (
