...
function OwnNFT() {
  ...
  const listP = async (e) => {
    ...
    const erc20 = new ethers.Contract(
      "0x45d613b7aa8786edcd7040ebbd29b087c17d3335",
      Abi,
      signer
    );
            ...
            <div className="col-lg-12 col-md-12 article">
              <div className="shopcontainer row justify-center">
                ...
                {fullProduct.length == 0 ? (
                  <div className="spinner-border animate-spin m-auto rounded-full flex justify-center text-blue-600 ">
                    {" "}
                  </div>
                ) : (
                      ...
                      <div className="border-product">
                        ...
                        <div className="shoptext ">
                          ...
                          <div className="detail-list">
                            ...
                            <span>
                              <button
                                onClick={() => showWarranty(product.tokenURI)}
                              >
                                Warranty Card
                              </button>
                            </span>
                            <span>
                              <button
                                onClick={() =>
                                  sellnft(product.price, product.tokenId)
                                }
                              >
                                Sell NFT
                              </button>
